...
class CollaborativeFilteringEngine(BaseRecommendationEngine):
    ...
    def _get_model(self, df_interactions: Optional[pd.DataFrame] = None):
        ...
        try:
            ...
            self._model = CollaborativeFilteringRecommender()
            if df_interactions is not None:
                self._model.fit(df_interactions)
        return self._model
    ...
    def recommend(
        ...
        **kwargs
        ...
        model = self._get_model(df_interactions)
