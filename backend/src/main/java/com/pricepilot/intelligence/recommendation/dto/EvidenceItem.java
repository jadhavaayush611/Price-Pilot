...
/**
 * Structured evidence representation tracing recommendation decisions back to factual product & comparison data.
 */
public class EvidenceItem {
    ...
    public EvidenceItem(UUID productId, String productName, EvidenceType type, String description,
