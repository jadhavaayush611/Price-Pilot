    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/alerts/**", "/api/v1/watchlists/**", "/api/v1/dashboard/**", "/api/v1/users/preferences/**", "/api/v1/assistant/**").authenticated()
                ...
                .requestMatchers("/api/v1/alternatives/**").permitAll()
